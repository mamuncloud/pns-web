    ...
    <section className="max-w-7xl mx-auto px-6 mb-24">
      <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
        <div className="w-full md:w-1/2 space-y-8">
          ...
          <p className="text-on-background/70 text-lg md:text-xl max-w-lg leading-relaxed font-medium">
            Kelezatan autentik dengan bumbu melimpah. Dari Basreng hingga Keripik Singkong, semua ada di Planet Nyemil Snack.
          </p>
          <div className="flex flex-wrap gap-4 pt-4">
            <button className="bg-primary text-white px-10 py-4 rounded-full font-bold text-lg shadow-xl shadow-primary/20 hover:scale-105 transition-all">
              Pesan Sekarang
            </button>
          </div>
        </div>
